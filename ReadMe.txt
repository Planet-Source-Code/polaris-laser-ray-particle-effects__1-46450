...
'========================================
'
This little Demo shows how to generate infinite particle effects thanks to NemoX engine
to make it run you need the NemoX engine files:
http://perso.wanadoo.fr/malakoff/NemoXsetup1.074.exe

Welcome to the NemoX engine Tutorial Series

Tut 14 - Adding Particle FX
